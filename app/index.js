...
const {updateTaskStatus,updateTaskSection,deleteTaskController,getByProjectIdController,addTask,assignUserToTask,getTaskUsersByTaskId,getTaskByProjectIdWithUserController,getActiveTask,getBacklogTask}=require("./router/taskRouter")
...
app.get("/tasks/getprojectwithuser/:projectId/active",getActiveTask)
app.get("/tasks/getprojectwithuser/:projectId/backlog",getBacklogTask)
